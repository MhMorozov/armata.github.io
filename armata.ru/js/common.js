...
$(document).ready(function(){
    $('a.yakor[href^="#assessment"], *[data-href^="#assessment"]').on('click', function(e){
        e.preventDefault();
    ...
    $('a.yakor[href^="#deals"], *[data-href^="#deals"]').on('click', function(e){
        e.preventDefault();
        var t = 1000; //Скорость скролла
        var d = $(this).attr('data-href') ? $(this).attr('data-href') : $(this).attr('href');
        $('html,body').stop().animate({ scrollTop: $(d).offset().top - 0 }, t);
    ...
    $('a.yakor[href^="#benefits"], *[data-href^="#benefits"]').on('click', function(e){
        e.preventDefault();
        var t = 1000; //Скорость скролла
        var d = $(this).attr('data-href') ? $(this).attr('data-href') : $(this).attr('href');
        $('html,body').stop().animate({ scrollTop: $(d).offset().top - 0 }, t);
